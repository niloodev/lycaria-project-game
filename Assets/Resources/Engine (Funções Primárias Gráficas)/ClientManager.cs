...
{
    #region Variave�s de Ambiente (Est�ticas)
    ...
    // Pra identificar o usu�rio e seu personagem de escolha.
    ...
    #region Fun��es de Inicializa��o de Entidades e Gerenciamento de Pacotes Prontos
    ...
    #region Entidades e Elementos (Sincroniza��o)

    // Inicializa as entidades e sincroniza a exist�ncia delas com o servidor.
    ...
    // Inicializa os elementos e sincroniza a exist�ncia deles com o servidor.
    ...
    // Sincroniza a exist�ncia das anima��es espont�neas.
    ...
    // Inicializa as opera��es de CheckAction (Minigames para conclus�o de habilidades).
    static void CheckActionSync()
    {
        ...
        {
            // Verifica se � pra selecionar alvo.
    ...
    // Fun��o que retorna os alvos selecionados.
    ...
    static async void Connect()
    {
        try
        {
            ...
            {             
                // Se a partida n�o estiver acontecendo ainda, todas as entidades far�o anima��o de entrada.
                if(!matchIsRunning)
                {
                    EndAwaitScreen();
                    GameRoom.State.entities.ForEach((entityId, character) => {
